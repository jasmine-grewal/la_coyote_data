...
left <- C131_C171_summary |>
filter(ID %in% c("C144", "C145", "C146", "C147", "C149", "C151", "C153", "C154", "C155", "C156", "C157", "C161"))

left <- left[!is.na(left$Longitude) & !is.na(left$Latitude),]

left_sf <- st_as_sf(left, coords = c("Longitude", "Latitude"), crs = 4326)

mapview(zcol = "ID", left_sf, legend = F, cex = 3)
```
C162
```{r}
